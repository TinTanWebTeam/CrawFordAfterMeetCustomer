            ...
            <div class="report">
                <div class="page" id="page_1">
                    <div class="wip-header">
                        <div class="content-body">
                            <div class="wip-header-row-1">
                                <div class="wip-header-row-1-left">
                                    <span>Work In Progress By</span>    
                                </div>
                                <div class="wip-header-row-1-right">
                                    <span>Printed : 20/07/2016 2:53:23 PM</span>
                                </div>
                            </div>
                            <div class="wip-header-row-2">
                                <div class="wip-header-row-2-left">
                                    <div class="wip-header-row-2-left-row-1">
                                        <span>As Of: <div class="as-of">20-Jul-2016</div></span> 
                                    </div>
                                    <div class="wip-header-row-2-left-row-2">
                                        <span>Branch:<div class="branch">HC1A</div></span> 
                                    </div>  
                                </div>
                                <div class="wip-header-row-2-right">
                                    <div class="wip-header-row-2-right-row-1">
                                        <span>Region: <div class="region">%</div></span>
                                    </div>
                                    <div class="wip-header-row-2-right-row-2">
                                        <span>WIP Value Greater Than: <div class="wip-value">0.00</div></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="wip-content-header">
                        <div></div>
                        <div></div>
                        <div></div>
                        <div></div>
