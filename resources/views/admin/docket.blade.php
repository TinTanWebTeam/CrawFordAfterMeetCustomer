        ...
        <div class="row" style="padding: 20px;">
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="claimId" value="" style="display: inline-block">
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="employeeId" value="" style="display: inline-block">
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="insuredName" value="" style="display: inline-block;">
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="lossDate" value="" style="display: inline-block;">
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="lossLocation" value="" style="display: inline-block;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <form action="" style="background-color: #fff;width: 100%">
                    ...
                    <div class="col-sm-12" >
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="" name="" value="1" style="width: auto">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-4">
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="" name="" value="1" style="width:80px">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-4">
        ...
        <div class="row">
            <div class="col-sm-12" style="padding-right: 40px">
                <button class="btn btn-danger pull-right" style="margin-left: 20px">Cancel</button>
